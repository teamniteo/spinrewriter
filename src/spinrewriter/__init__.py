...
class Api(object):
    ...
    def _transform_plain_text(self, action, text, protected_terms, confidence_level,
        ...
        :rtype: dictionary
        """
        #NOTE: this could be improved to conditionally include some
        # optional params (their default values would be None),
        # but it's only a minor optimization
        # and would make code a bit more complicated
